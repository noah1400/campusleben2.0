...
export default {
    ...
    methods: {
        getSponsor() {
            let vm = this;
            axios.get('/api/sponsor/'+vm.sponsor_id)
                .then((response) => {
                    vm.sponsor = response.data;
                    vm.imageSrc = "/storage/"+vm.sponsor.image;
                    vm.active_sponsor = vm.sponsor.active;
                })
                .catch((error) => {
                    console.log(error);
                });
        ...
        submitSponsor() {
            ...
            let vm = this;
            this.loader = true;
            axios.post('/admin/api/sponsors/update/' + vm.sponsor_id, formData, {
                    headers: {
