...
@section('content')
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            <div>
                <a href="{{ route('home') }}"> <img class="mx-auto h-12 w-auto" src="{{ asset('storage/images/csm_logo_campusleben.png') }}"
                    alt="Workflow"></a>
                    ...
                    <div class="flex alert-del">
                        ...
                        <div class="ml-auto pl-3">
                            <div class="-mx-1.5 -my-1.5">
                                <button type="button"
                                    class="inline-flex bg-red-50 rounded-md p-1.5 text-red-700 hover:bg-red-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-green-50 focus:ring-red-600">
            ...
            <form class="mt-8 space-y-6" action="{{ route('login') }}" method="POST">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="{{ route('register') }}" class="font-medium text-indigo-600 hover:text-indigo-500"> No
                            account yet? </a>
                    </div>
                </div>
