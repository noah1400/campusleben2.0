    ...
    <div class="w-full min-h-screen bg-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <p class="mt-0 mb-4">Sofern Sie uns eine Einwilligung erteilt haben, können Sie diese jederzeit mit Wirkung für die Zukunft
                    widerrufen.</p>
                <p class="mt-0 mb-4">Sie können sich jederzeit mit einer Beschwerde an eine Aufsichtsbehörde wenden, z. B. an die zuständige
                    Aufsichtsbehörde des Bundeslands Ihres Wohnsitzes oder an die für uns als verantwortliche Stelle
                    zuständige Behörde.</p>
                <p class="mt-0 mb-4">Eine Liste der Aufsichtsbehörden (für den nichtöffentlichen Bereich) mit Anschrift finden Sie unter: <a
                ...
                <p class="mt-0 mb-4"></p>
                <h2 class="h2">Erfassung allgemeiner Informationen beim Besuch unserer Website</h2>
                <h3 class="h3">Art und Zweck der Verarbeitung:</h3>
                <p class="mt-0 mb-4">Wenn Sie auf unsere Website zugreifen, d.h., wenn Sie sich nicht registrieren oder anderweitig
                ...
                <p class="mt-0 mb-4">Wir verwenden Ihre Daten nicht, um Rückschlüsse auf Ihre Person zu ziehen. Informationen dieser Art
                ...
                <h3 class="h3">Rechtsgrundlage und berechtigtes Interesse:</h3>
                <p class="mt-0 mb-4">Die Verarbeitung erfolgt gemäß Art. 6 Abs. 1 lit. f DSGVO auf Basis unseres berechtigten Interesses an
                    der Verbesserung der Stabilität und Funktionalität unserer Website.</p>
                <h3 class="h3">Empfänger:</h3>
                <p class="mt-0 mb-4">Empfänger der Daten sind ggf. technische Dienstleister, die für den Betrieb und die Wartung unserer
                    Webseite als Auftragsverarbeiter tätig werden.</p>
                <p class="mt-0 mb-4"></p>
                <h3 class="h3">Speicherdauer:</h3>
                <p class="mt-0 mb-4">Die Daten werden gelöscht, sobald diese für den Zweck der Erhebung nicht mehr erforderlich sind. Dies ist
                    für die Daten, die der Bereitstellung der Website dienen, grundsätzlich der Fall, wenn die jeweilige
                    Sitzung beendet ist. </p>
                <p class="mt-0 mb-4"> Im Falle der Speicherung der Daten in Logfiles ist dies nach spätestens 14 Tagen der Fall. Eine
                ...
                <p class="mt-0 mb-4"></p>
                <h3 class="h3">Bereitstellung vorgeschrieben oder erforderlich:</h3>
                <p class="mt-0 mb-4">Die Bereitstellung der vorgenannten personenbezogenen Daten ist weder gesetzlich noch vertraglich
                ...
                <p class="mt-0 mb-4">Zum Zeitpunkt der Registrierung werden zusätzlich folgende Daten erhoben:</p>
                <p class="mt-0 mb-4">Zeitstempel</p>
                <p class="mt-0 mb-4">Ihre Registrierung ist für das Bereithalten bestimmter Inhalte und Leistungen auf unserer Website
                    erforderlich.</p>
                <h3 class="h3">Rechtsgrundlage:</h3>
                <p class="mt-0 mb-4">Die Verarbeitung der bei der Registrierung eingegebenen Daten erfolgt auf Grundlage einer Einwilligung
                ...
                <p class="mt-0 mb-4"></p>
                <h3 class="h3">Speicherdauer:</h3>
                <p class="mt-0 mb-4">Daten werden in diesem Zusammenhang nur verarbeitet, solange die entsprechende Einwilligung vorliegt.
                </p>
                <h3 class="h3">Bereitstellung vorgeschrieben oder erforderlich:</h3>
                <p class="mt-0 mb-4">Die Bereitstellung Ihrer personenbezogenen Daten erfolgt freiwillig, allein auf Basis Ihrer Einwilligung.
                ...
                <p class="mt-0 mb-4"></p>
                <h2 class="h2">SSL-Verschlüsselung</h2>
                <p class="mt-0 mb-4">Um die Sicherheit Ihrer Daten bei der Übertragung zu schützen, verwenden wir dem aktuellen Stand der
                    Technik entsprechende Verschlüsselungsverfahren (z. B. SSL) über HTTPS.</p>
                <p class="mt-0 mb-4"></p>
                <hr class="my-3 border-gray-400">
                <h2 class="h2">Information über Ihr Widerspruchsrecht nach Art. 21 DSGVO</h2>
                <h3 class="h3">Einzelfallbezogenes Widerspruchsrecht</h3>
                <p class="mt-0 mb-4">Sie haben das Recht, aus Gründen, die sich aus Ihrer besonderen Situation ergeben, jederzeit gegen die
                ...
                <p class="mt-0 mb-4">Legen Sie Widerspruch ein, werden wir Ihre personenbezogenen Daten nicht mehr verarbeiten, es sei denn,
                ...
                <p class="mt-0 mb-4">Wenn Sie Fragen zum Datenschutz haben, schreiben Sie uns bitte eine E-Mail oder wenden Sie sich direkt an
                    die für den Datenschutz verantwortliche Person in unserer Organisation:</p>
                <p class="mt-0 mb-4">campusleben@hs-esslingen.de</p>
                <p class="mt-0 mb-4"><em>Die Datenschutzerklärung wurde mithilfe der activeMind AG erstellt, den Experten für <a
